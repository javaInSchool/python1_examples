...
class Game:
    def __init__(self):
        ...
        self.bg = PhotoImage(file="../back.gif")
        w = self.bg.width()
        h = self.bg.height()
        for x in range(0, 5):
            for y in range(0, 5):
...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [
            PhotoImage(file="stickL1.gif"),
            PhotoImage(file="stickL2.gif"),
            PhotoImage(file="stickL3.gif")
        ]
        self.images_right = [
            PhotoImage(file="stickR1.gif"),
            PhotoImage(file="stickR2.gif"),
            PhotoImage(file="stickR3.gif")
        ]
